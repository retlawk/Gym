...
@Component({
  selector: 'app-upper2019-07',
  templateUrl: './upper2019-07.component.html',
  styleUrls: ['./upper2019-07.component.scss']
})
export class Upper201907Component implements OnInit {
